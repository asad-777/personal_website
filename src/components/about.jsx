...
export default function About() {
    return (
        <section
            id="about"
            className="relative w-full min-h-[50vh] bg-transparent flex items-center justify-center py-20 pt-40 px-6 md:px-16 overflow-hidden"
        >
            <div className="relative z-10 w-full max-w-2xl mx-auto px-8 flex flex-col items-center text-center gap-6">

                <ScrollReveal delay={0.1}>
                    <h2
                        className="text-4xl md:text-5xl hide-dominoes lg:text-6xl font-extrabold tracking-tight text-base-content"
                ...
                <ScrollReveal delay={0.3}>
                    <p className="text-base-content hide-dominoes md:text-lg rounded-full  leading-relaxed">
                ...
                <ScrollReveal delay={0.4}>
                    <p className="text-base-content hide-dominoes rounded-full md:text-lg leading-relaxed">
