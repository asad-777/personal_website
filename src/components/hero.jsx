        ...
        <div className="relative w-fit  h-full flex flex-col items-start lg:items-end justify-center mt-8 lg:mt-0 gap-10">
          ...
          <div className="hidden lg:flex flex-col gap-8 w-full">
            <div className="flex gap-4 w-full ">
              <GlassSurface width="100%" height={56} borderRadius={9999} backgroundOpacity={0.05} borderWidth={0.5} className="cursor-pointer hover:scale-[1.02] transition-transform w-full group">
                <a
                  ...
                  onClick={(e) => {
                      e.preventDefault();
                      track("lets_connect_click", { location: "hero" });
              ...
              <GlassSurface width="100%" height={56} borderRadius={9999} backgroundOpacity={0.05} borderWidth={0.5} className="cursor-pointer hover:scale-[1.02] transition-transform w-full group">
                <a
                  href="/cv.pdf"
                  target="_blank"
                  onClick={() => track("download_cv_click", { location: "hero" })}
                  className="flex bg-primary text-primary-content rounded-full items-center justify-center w-full h-full text-lg transition-colors"
                >
                  Download CV
                </a>
            ...
            <div className="flex gap-10 w-full bg-base-100/70 rounded-xl px-6 py-2 justify-center lg:justify-center px-2">
              <a href="https://github.com/yourusername" target="_blank" rel="noopener noreferrer" onClick={() => track("social_click", { platform: "GitHub", location: "hero" })} className="group btn btn-ghost hover:text-primary lg:btn-lg flex items-center gap-2 text-base-content/60 transition-colors text-sm">
                <FaGithub className="w-5 h-5" />
                <span>GitHub</span>
              </a>

              <a href="https://linkedin.com/in/yourusername" target="_blank" rel="noopener noreferrer" onClick={() => track("social_click", { platform: "LinkedIn", location: "hero" })} className="group btn btn-ghost hover:text-primary lg:btn-lg flex items-center gap-2 text-base-content/60 transition-colors text-sm">
                <FaLinkedin className="w-5 h-5" />
                <span>LinkedIn</span>
              </a>

              <a href="mailto:your@email.com" onClick={() => track("social_click", { platform: "Gmail", location: "hero" })} className="group btn btn-ghost hover:text-primary lg:btn-lg flex items-center gap-2 text-base-content/60 transition-colors text-sm ">
